...
class CulcXYZ{
	...
	transXYZtoRGB(inXYZ){
		...
		var r = x>0.0032308 ? (math.pow(1.055*x,1/2.4)-0.055) : x*12.92;
		var g = y>0.0032308 ? (math.pow(1.055*y,1/2.4)-0.055) : y*12.92;
		var b = z>0.0032308 ? (math.pow(1.055*z,1/2.4)-0.055) : z*12.92;
