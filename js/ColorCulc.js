function colorCulc() {
	...
	//////計算の前処理//////
	//inputフォームのデータを配列に格納
	var commonXYZColor1 = culcXYZ.makeXYZMatrix(Color1,INPUT_TYPE_SMALL_XYZ);
	var commonXYZColor2 = culcXYZ.makeXYZMatrix(Color2,INPUT_TYPE_SMALL_XYZ);
...
function colorCulc_sRGB() {
	...
	//////計算の前処理//////
	//inputフォームのデータを配列に格納
	var commonXYZColor1 = culcXYZ.makeXYZMatrix(Color1,INPUT_TYPE_SRGB);
	var commonXYZColor2 = culcXYZ.makeXYZMatrix(Color2,INPUT_TYPE_SRGB);
