function colorCulc(InputType) {
	...
	if(InputType == INPUT_TYPE_SMALL_XYZ){
		...
		console.log(culcXYZ.culcSmallXYZ(commonXYZColor1_renew));
		console.log(culcXYZ.culcSmallXYZ(commonXYZColor2_renew));
		...
		console.log(culcXYZ.culcSmallXYZ(protanRGBColor1));
		console.log(culcXYZ.culcSmallXYZ(protanRGBColor2));
		...
		console.log(culcXYZ.culcSmallXYZ(deutanRGBColor1));
		console.log(culcXYZ.culcSmallXYZ(deutanRGBColor2));
